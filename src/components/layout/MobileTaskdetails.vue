<template>
    <div>
        <div class="top-bar-with-close hover-effect">
            <i class="material-icons" @click="$emit('closeMobileTaskDetails')">close</i>
        </div>
        <div class="generic-container" @click="showDetails">
            ...
            <div class="add-button-container-for-more-margin">
                <div class="generic-icon-and-text" @click="focusNewSubtaskField">
